...
class Agent(resource.CoAPResource):
    ...
    def create_metering_response(self ):
        """
...
# Run the server on coap default port ( 5684 ) 
reactor.listenUDP(coap.COAP_PORT+1, coap.Coap(endpoint)) #, interface="::")
reactor.run()
